  ...
  if (display::showRTCtime) {
    ...
    if (millis() - lastTouchTime >= 1500UL) {
      if (display::touch_x >= 760 && display::touch_x <= 800 && display::touch_y >= 100 && display::touch_y <= 140) {
        ...
        display::settingsPageZeroScrollPos = map(display::touch_y, 140, 430, 0, 3);
    ...
    if (display::settingsPageZeroScrollPos <= 2) {
      if (display::touch_x >= 680 && display::touch_x <= 750 && display::touch_y >= 270 - scrollMargin && display::touch_y <= 300 - scrollMargin) { // graphInterval
        beep();
    ...
    if (display::settingsPageZeroScrollPos <= 3) {
      if (display::touch_x >= 680 && display::touch_x <= 750 && display::touch_y >= 320 - scrollMargin && display::touch_y <= 350 - scrollMargin) { // setrtc
        beep();
        rtc.refresh();
    ...
    if (display::settingsPageZeroScrollPos <= 4) {
      if (display::touch_x >= 680 && display::touch_x <= 750 && display::touch_y >= 370 - scrollMargin && display::touch_y <= 400 - scrollMargin) { // convertToFarenheit
    ...
    if (display::settingsPageZeroScrollPos <= 5) {
      if (display::touch_x >= 680 && display::touch_x <= 750 && display::touch_y >= 420 - scrollMargin && display::touch_y <= 450 - scrollMargin) { // convertToInches
    ...
    if (display::settingsPageZeroScrollPos >= 1 && display::settingsPageZeroScrollPos <= 6) {
      if (display::touch_x >= 680 && display::touch_x <= 750 && display::touch_y >= 470 - scrollMargin && display::touch_y <= 500 - scrollMargin) { // convertToTds
        beep();
    ...
    if (display::settingsPageZeroScrollPos >= 2 && display::settingsPageZeroScrollPos <= 7) {
      if (display::touch_x >= 680 && display::touch_x <= 750 && display::touch_y >= 520 - scrollMargin && display::touch_y <= 550 - scrollMargin) { // EC conversion mode
