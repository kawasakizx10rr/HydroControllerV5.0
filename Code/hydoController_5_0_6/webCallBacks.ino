...
void handleRoot() {
  Serial.print(F("handleRoot: Executing on core ")); Serial.println(xPortGetCoreID());
  ...
  Serial.print(F("Sending html file, file size: ")); Serial.println(sizeof(htmlText));
...
void setValue() {
  Serial.print(F("setValue: Executing on core ")); Serial.println(xPortGetCoreID());
  yield();
...
void getPageData() {
  Serial.print(F("getPagedata: Executing on core ")); Serial.println(xPortGetCoreID());
  yield();
  String page = server.arg("page");
  String slide = server.arg("slide");
  Serial.print(F("Received web request for page ")); Serial.print(page); Serial.print(F(" and slide ")); Serial.println(slide);
