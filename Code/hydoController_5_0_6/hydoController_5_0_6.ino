...
// AC IR LED
const uint8_t irLed = 25;
// Auxiliary relays
const byte auxRelayOne = 13;
const byte auxRelayTwo = 14; // outputs PWM signal at boot
// const byte unused = 34; // input only
// const byte unused = 35; // input only
}
...
const char* versionNumber = "5.0.6";
