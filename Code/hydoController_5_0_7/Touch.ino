...
void fansPageTouched() {
  ...
  //
    ...
    if (display::airSettingsScrollPos <= 4) { // disable/enable fanOne
    ...
    if (display::airSettingsScrollPos <= 5) { // disable/enable fanTwo
    ...
    if (display::airSettingsScrollPos >= 1 && display::airSettingsScrollPos <= 6) { // AC control temperature
    ...
    if (display::airSettingsScrollPos >= 2 && display::airSettingsScrollPos <= 7) { // AC control humidity
    ...
    if (display::airSettingsScrollPos >= 3 && display::airSettingsScrollPos <= 8) { // AC swing vertical
    ...
    if (display::airSettingsScrollPos >= 4 && display::airSettingsScrollPos <= 9) { // AC swing horizontal
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 630 - scrollMargin && display::touch_y <= 670 - scrollMargin) {
        beep();
        user::acSwingHorizontal = !user::acSwingHorizontal; 
      }
    }
    if (display::airSettingsScrollPos >= 5 && display::airSettingsScrollPos <= 10) { // AC turbo mode
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 680 - scrollMargin && display::touch_y <= 720 - scrollMargin) {
        beep();
    ...
    // vertical menu slider
      ...
      beep();
      display::airSettingsScrollPos = map(display::touch_y, 140, 430, 0, 6);
      if (display::airSettingsScrollPos > 5)
        display::airSettingsScrollPos = 5;
...
void runDosersTouch(bool* a_enabledDosers, uint32_t& a_lastTouch) {
