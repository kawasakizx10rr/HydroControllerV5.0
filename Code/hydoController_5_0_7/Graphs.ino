...
void drawGraph (
  ...
  const int16_t& a_graphWidth, const int16_t& a_numYLabels, float** a_data, const int16_t a_numArrays, 
  const int16_t& a_arrayNumber, const int16_t& a_percision, const uint16_t* a_colors)
{
