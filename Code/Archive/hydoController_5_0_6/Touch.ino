  ...
  if (touched()) {
    ...
    if (display::touch_x > 0 && display::touch_y > 0) {     
      ...
      if (millis() - display::previousTouchMillis >= display::debounceTime) {       
        if ((display::touch_x >= 1 && display::touch_x <= 80 && display::touch_y >= 1 && display::touch_y <= 480)
        || (display::touch_x >= 1 && display::touch_x <= 800 && display::touch_y >= 1 && display::touch_y <= 80)) {
          mainMenuNavigation();
        }
        else {
          adjustPageValues();
...
bool touched() {
  if (display::usingCapacitiveTouch) {
    if(digitalRead(pin::ra8875_touchInt) == HIGH) {
      display::touch_x = gsl1680.readFingerX(0);
      display::touch_x = gsl1680.readFingerX(0);
      return true;
    }
  }
...
void mainMenuNavigation() {
  if (!display::displayIsOff) {
    if (display::touch_x >= 10 && display::touch_x <= 90 && display::touch_y >= 90 && display::touch_y <= 160) { // HOME
      ...
      display::showWaterHeightCalibration = false;
    ...
    else if (display::touch_x >= 507 && display::touch_x <= 587 && display::touch_y >= 1 && display::touch_y <= 100) { // TIMERS
      setPage(10);
    }
...
void sliders() {
  ...
  // Settings page zero Y axsis slider
    ...
    //
      ...
      if (!display::showRTCtime) {
        if (slideYIncrement == 1 && display::settingsPageZeroScrollPos < 3) {
  ...
  // Fans page X axsis slider
    ...
    if (slideXIncrement == 1 && display::fansPage < 5) {
      display::fansPage++;
      display::refreshPage = true;
      beep();
      clearPage();
    ...
    if (display::fansPage == 4 && user::selectedIrPos >= 4) {
      display::irCodesPageScrollPos = user::selectedIrPos - 4;
    }
  }
...
void settingsFourPageTouched() {
  ...
  if (display::showWaterHeightCalibration) {
      ...
      if (n == 0) {
        if (display::touch_x >= 105 - startPosition && display::touch_x <= 180 - startPosition && display::touch_y >= 370 && display::touch_y <= 410) // doser speed 1 down
          ...
          if (!device::doserIsPriming[n] && millis() - device::primeTouchTime >= 1500UL)
            prime(1, device::pca9685Channel::doserOne, user::doserOneSpeed);
          else if (millis() - device::primeTouchTime >= 1500UL)
            prime(1, device::pca9685Channel::doserOne, 0);
        }
      }
      else if (n == 1) {
        if (display::touch_x >= 278 - startPosition && display::touch_x <= 358 - startPosition && display::touch_y >= 370 && display::touch_y <= 410) // doser speed 2 down
          ...
          if (!device::doserIsPriming[n] && millis() - device::primeTouchTime >= 1500UL)
            prime(2, device::pca9685Channel::doserTwo, user::doserTwoSpeed);
          else if (millis() - device::primeTouchTime >= 1500UL)
            prime(2, device::pca9685Channel::doserTwo, 0);
        }
      }
      else if (n == 2) {
        if (display::touch_x >= 458 - startPosition && display::touch_x <= 538 - startPosition && display::touch_y >= 370 && display::touch_y <= 410) // doser speed 3 down
          ...
          if (!device::doserIsPriming[n] && millis() - device::primeTouchTime >= 1500UL)
            prime(3, device::pca9685Channel::doserThree, user::doserThreeSpeed);
          else if (millis() - device::primeTouchTime >= 1500UL)
            prime(3, device::pca9685Channel::doserThree, 0);
        }
      }
      else if (n == 3) {
        if (display::touch_x >= 635 - startPosition && display::touch_x <= 702 - startPosition && display::touch_y >= 370 && display::touch_y <= 410) // doser speed 4 down
          ...
          if (!device::doserIsPriming[n] && millis() - device::primeTouchTime >= 1500UL)
            prime(4, device::pca9685Channel::doserFour, user::doserFourSpeed);
          else if (millis() - device::primeTouchTime >= 1500UL)
            prime(4, device::pca9685Channel::doserFour, 0);
        }
      }
      else if (n == 4) {
        if (display::touch_x >= 813 - startPosition && display::touch_x <= 880 - startPosition && display::touch_y >= 370 && display::touch_y <= 410) // doser speed 5 down
          ...
          if (!device::doserIsPriming[n] && millis() - device::primeTouchTime >= 1500UL)
            prime(5, device::pca9685Channel::doserFive, user::doserFiveSpeed);
          else if (millis() - device::primeTouchTime >= 1500UL)
            prime(5, device::pca9685Channel::doserFive, 0);
        }
      }
      else if (n == 5) {
        if (display::touch_x >= 991 - startPosition && display::touch_x <= 1058 - startPosition && display::touch_y >= 370 && display::touch_y <= 410) // doser speed 6 down
          ...
          if (!device::doserIsPriming[n] && millis() - device::primeTouchTime >= 1500UL)
            prime(6, device::pca9685Channel::doserSix, user::doserSixSpeed);
          else if (millis() - device::primeTouchTime >= 1500UL)
            prime(6, device::pca9685Channel::doserSix, 0);
        }
      }
    }
  ...
  //
  else if (display::touch_x >= 700 && display::touch_x <= 770 && display::touch_y >= 170 && display::touch_y <= 200) { // showWaterHeightCalibration
    if (user::heightSensor == user::VL53L0X) {
      beep();
      display::showWaterHeightCalibration = true;
      display::showingDialog = true;
      display::refreshPage = true;
    }
    else {
...
void timerPagedTouched() {
  if (display::timerPagePageScrollPos == 0) {
    ...
    if (display::touch_x >= 260 && display::touch_x <= 310 && display::touch_y >= 330 && display::touch_y <= 400) { // timer down
      ...
      digitalWrite(pin::auxRelayOne, HIGH);
      device::settingsAdjusted = true;
    }
      ...
      device::auxRelayOneOn = true;
      if (rtc.minute() < 59) {
        device::auxRelayOneSwitchedOnOffMin = rtc.minute() + 1;
        device::auxRelayOneSwitchedOnOffHour = rtc.hour();
      }
      else {
        device::auxRelayOneSwitchedOnOffMin = 0;
        rtc.hour() < 23 ? device::auxRelayOneSwitchedOnOffHour = rtc.hour()+1 : device::auxRelayOneSwitchedOnOffHour = 0;
      }
      device::settingsAdjusted = true;
    }
      ...
      digitalWrite(pin::auxRelayOne, LOW);
      device::settingsAdjusted = true;
    }
    else if (display::touch_x >= 770 && display::touch_x <= 800 && display::touch_y >= 120 && display::touch_y <= 140) { // show info dialog
      message::infoPos = 35;
    ...
    if (display::touch_x >= 260 && display::touch_x <= 310 && display::touch_y >= 330 && display::touch_y <= 400) { // timer down
      ...
      digitalWrite(pin::auxRelayTwo, HIGH);
      device::settingsAdjusted = true;
    }
      ...
      device::auxRelayTwoOn = true;
      if (rtc.minute() < 59) {
        device::auxRelayTwoSwitchedOnOffMin = rtc.minute() + 1;
        device::auxRelayTwoSwitchedOnOffHour = rtc.hour();
      }
      else {
        device::auxRelayTwoSwitchedOnOffMin = 0;
        rtc.hour() < 23 ? device::auxRelayTwoSwitchedOnOffHour = rtc.hour()+1 : device::auxRelayTwoSwitchedOnOffHour = 0;
      }
      device::settingsAdjusted = true;
    }
      ...
      digitalWrite(pin::auxRelayTwo, LOW);
      device::settingsAdjusted = true;
    }
    else if (display::touch_x >= 770 && display::touch_x <= 800 && display::touch_y >= 120 && display::touch_y <= 140) { // show info dialog
      message::infoPos = 36;
...
void fansPageTouched() {
  ...
  // Select IR protocol
    ...
    if (display::touch_x >= 350 && display::touch_x <= 460 && display::touch_y >= 415 && display::touch_y <= 470) { // Test
      beep();
      device::irPreviousMillis = 0;
      acControl();
    }
    // vertical menu slider
    else if (display::touch_x >= 756 && display::touch_x <= 799 && display::touch_y >= 100 && display::touch_y <= 140) {
      if (display::irCodesPageScrollPos > 0) {
        beep();
        display::irCodesPageScrollPos--;
        display::refreshPage = true;
        clearPage();
      }
    }
    else if (display::touch_x >= 756 && display::touch_x <= 799 && display::touch_y > 140 && display::touch_y < 430) {
      beep();
      display::irCodesPageScrollPos = map(display::touch_y, 140, 430, 0, totalIRTitles - 5);
      if (display::irCodesPageScrollPos > totalIRTitles - 6)
        display::irCodesPageScrollPos = totalIRTitles - 6;
      //Serial.print(F("IR slider menu pos = ")); Serial.println(display::irCodesPageScrollPos);
      display::refreshPage = true;
      clearPage();
    }
    else if (display::touch_x >= 756 && display::touch_x <= 799 && display::touch_y >= 430 && display::touch_y <= 470) {
      beep();
      if (display::irCodesPageScrollPos < totalIRTitles - 6) {
        display::irCodesPageScrollPos++;
        display::refreshPage = true;
    ...
    // Select IR protocol
    else if (display::touch_x >= 650 && display::touch_x <= 720 && display::touch_y >= 172 && display::touch_y <= 397) {
      beep();
      device::lastIrSelection = user::selectedIrPos;
      user::selectedIrPos = ((display::touch_y - 172) / 45) + display::irCodesPageScrollPos;
      Serial.print(F("selectedIrPos = ")); Serial.println(user::selectedIrPos);
    }
     // show info dialog
    else if (display::touch_x >= 710 && display::touch_x <= 750 && display::touch_y >= 110 && display::touch_y <= 140) {
      message::infoPos = 37;
      display::showingDialog = true;
      display::showInfoDialog = true;
      display::refreshPage = true;
  ...
  //
    ...
    if (display::airSettingsScrollPos == 0) { // disable/enable fansControlTemperature
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 180 - scrollMargin && display::touch_y <= 220 - scrollMargin) {
        beep();
        user::fansControlTemperature = !user::fansControlTemperature; 
      }
    }
    if (display::airSettingsScrollPos <= 1) { // disable/enable fansControlHumidity
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 230 - scrollMargin && display::touch_y <= 270 - scrollMargin) {
        beep();
        user::fansControlHumidity = !user::fansControlHumidity; 
      }
    }
    if (display::airSettingsScrollPos <= 2) { // disable/enable fanOneFixedSpeed
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 280 - scrollMargin && display::touch_y <= 320 - scrollMargin) {
        beep();
        user::fanOneFixedSpeed = !user::fanOneFixedSpeed; 
      }
    }
    if (display::airSettingsScrollPos <= 3) { // disable/enable fanTwoFixedSpeed
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 330 - scrollMargin && display::touch_y <= 370 - scrollMargin) {
        beep();
        user::fanTwoFixedSpeed = !user::fanTwoFixedSpeed; 
      }
    }
    if (display::airSettingsScrollPos <= 4) { // AC control temperature
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 380 - scrollMargin && display::touch_y <= 420 - scrollMargin) {
        beep();
        user::acControlTemp = !user::acControlTemp; 
      }
    }
    if (display::airSettingsScrollPos <= 5) { // AC control humidity
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 430 - scrollMargin && display::touch_y <= 470 - scrollMargin) {
        beep();
        user::acControlHumidity = !user::acControlHumidity; 
      }
    }
    if (display::airSettingsScrollPos >= 1 && display::airSettingsScrollPos <= 6) { // AC swing vertical
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 480 - scrollMargin && display::touch_y <= 520 - scrollMargin) {
        beep();
        user::acSwingVertical = !user::acSwingVertical; 
      }
    }
    if (display::airSettingsScrollPos >= 2 && display::airSettingsScrollPos <= 7) { // AC swing horizontal
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 530 - scrollMargin && display::touch_y <= 570 - scrollMargin) {
        beep();
        user::acSwingHorizontal = !user::acSwingHorizontal; 
      }
    }
    if (display::airSettingsScrollPos >= 3 && display::airSettingsScrollPos <= 8) { // AC turbo mode
      if (display::touch_x >= 640 && display::touch_x <= 750 && display::touch_y >= 580 - scrollMargin && display::touch_y <= 620 - scrollMargin) {
        beep();
        user::acTurboMode = !user::acTurboMode; 
      }
    }
     // show info dialog
    if (display::touch_x >= 710 && display::touch_x <= 750 && display::touch_y >= 110 && display::touch_y <= 140) {
      message::infoPos = 18;
      display::showingDialog = true;
      display::showInfoDialog = true;
      display::refreshPage = true;
    ...
    // vertical menu slider
      ...
      beep();
      display::airSettingsScrollPos = map(display::touch_y, 140, 430, 0, 4);
      if (display::airSettingsScrollPos > 3)
        display::airSettingsScrollPos = 3;
      //Serial.print(F("IR slider menu pos = ")); Serial.println(display::airSettingsScrollPos);
      display::refreshPage = true;
      clearPage();
    }
    else if (display::touch_x >= 756 && display::touch_x <= 799 && display::touch_y >= 430 && display::touch_y <= 470) {
      beep();
      if (display::airSettingsScrollPos < totalIRTitles - 6) {
        display::airSettingsScrollPos++;
        display::refreshPage = true;
        clearPage();
      }
...
void launchCo2NotificationTouch(uint8_t& a_previousDate, uint8_t& a_continueCo2Control) {
  if (touched()) {
...
void waterLevelControlTouch(unsigned long& a_lastTouch, bool& a_startDraining) {
...
bool refillTankTouch(const unsigned long a_lastTouch) {
  const uint16_t startX = 166, startY = 166;
  if (touched()) {
    if (millis() > a_lastTouch) {
      if (display::touch_x >= startX + 200 && display::touch_x <= startX + 400 && display::touch_y >= startY + 200 && display::touch_y <= startY + 250) { // Cancel
        ...
        analogWriteChnl(device::pca9685Channel::doserOne, 0);
        analogWriteChnl(device::pca9685Channel::doserTwo, 0);
        analogWriteChnl(device::pca9685Channel::doserThree, 0);
        analogWriteChnl(device::pca9685Channel::doserFour, 0);
        analogWriteChnl(device::pca9685Channel::doserFive, 0);
        analogWriteChnl(device::pca9685Channel::doserSix, 0);
        beep();
        return true;
      }
    }
...
void abortCo2NotificationTouch(unsigned long& a_lastTouch, bool& a_startCo2Relay) {
  if (touched()) {
    const uint16_t startX = 166, startY = 166;
    if (millis() >= a_lastTouch) {
      if (display::touch_x >= startX + 200 && display::touch_x <= startX + 400 && display::touch_y >= startY + 200 && display::touch_y <= startY + 250) { // Cancel
        analogWriteChnl(device::pca9685Channel::co2Solenoid, (device::relayOffState == HIGH ? 4096 : 0));
        if (device::globalDebug)
...
void runDosersTouch(bool* a_enabledDosers, unsigned long& a_lastTouch) {
  const uint16_t startX = 166, startY = 166;
  if (touched()) {
    if (millis() >= a_lastTouch) {
      if (display::touch_x >= startX + 200 && display::touch_x <= startX + 400 && display::touch_y >= startY + 200 && display::touch_y <= startY + 250) { // Cancel
...
void launchDrainNotificationTouch(uint8_t& a_continueDraining, bool& a_startDraining) {
  if (touched()) {
    if (display::touch_x >= 276 && display::touch_x <= 416 && display::touch_y >= 366 && display::touch_y <= 412) { // Cancel
...
void launchRefillNotificationTouch(bool& a_startRefilling, uint8_t& a_continueRefilling) {
  if (touched()) {
    if (display::touch_x >= 276 && display::touch_x <= 416 && display::touch_y >= 366 && display::touch_y <= 412) { // Cancel
...
void displayDosingNotificationTouch(uint16_t startX, uint16_t startY) {
  if (touched()) {
