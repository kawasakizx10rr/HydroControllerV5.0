...
let targetWaterTankLength = 0;
let targetWaterTankWidth = 0;
// max mins
let minPh = 0;
let maxPh = 0;
let minCo2 = 0;
  ...
  <div id="tftDisplay">
    ...
    <div id="pageArea">
      ...
      <div id="page6" style="display:none;width:100%;height:100%;">
        ...
        <div style="display:block;width:50%;height:60%;float:left;">
          <div style="display:block;width:100%;height:50%;float:left;">
            <center>
              <b>
                <p id="targetMinEc" class="p5text" style="margin:0px;display:inline;">-</p>
              </b>
            </center>
          </div>
          <div style="display:block;width:100%;height:50%;float:left;">
            ...
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="ldbutt" alt="up arrow" onclick="adjustMinEc(-0.01)" style="float:right;"/>
            </div>
            <div style="display:block;width:20%;height:50%;float:left;"></div>
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="lubutt" alt="down arrow" onclick="adjustMinEc(0.01)" style="float:left;"/>
            </div>
            <div style="display:block;width:15%;height:50%;float:left;"></div>
          </div>
        </div>      
        <div style="display:block;width:50%;height:60%;float:left;">
          <div style="display:block;width:100%;height:50%;float:left;">
            <center>
              <b>
                <p id="targetMaxEc" class="p5text" style="margin:0px;display:inline;">-</p>
              </b>
            </center>
          </div>
          <div style="display:block;width:100%;height:50%;float:left;">
            <div style="display:block;width:15%;height:50%;float:left;"></div>
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="ldbutt" alt="up arrow" onclick="adjustMaxEc(-0.01)" style="float:right;"/>
            </div>
            <div style="display:block;width:20%;height:50%;float:left;"></div>
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="lubutt" alt="down arrow" onclick="adjustMaxEc(0.01)" style="float:left;"/>
            </div>
            <div style="display:block;width:15%;height:50%;float:left;"></div>
          </div>
        </div>        
      ...
      <div id="topbar" style="display:block;width:100%;"></div>
        <div style="display:block;width:100%;height:20%;float:left;">
          <b>
            <p ID="TargetPhTitle" style="margin:0px;text-align:center;" class="p3text">Target PH</p>
          </b>
        </div>
        ...
        <div style="display:block;width:50%;height:60%;float:left;">
          <div style="display:block;width:100%;height:50%;float:left;">
            <center>
              <b>
                <p id="targetMinPh" class="p5text" style="margin:0px;display:inline;">-</p>
              </b>
            </center>
          </div>
          <div style="display:block;width:100%;height:50%;float:left;">
            <div style="display:block;width:15%;height:50%;float:left;"></div>
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="ldbutt" alt="up arrow" onclick="adjustMinPh(-0.01)" style="float:right;"/>
            </div>
            <div style="display:block;width:20%;height:50%;float:left;"></div>
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="lubutt" alt="down arrow" onclick="adjustMinPh(0.01)" style="float:left;"/>
            </div>
            <div style="display:block;width:15%;height:50%;float:left;"></div>
          </div>
        </div>
        ...
        <div style="display:block;width:50%;height:60%;float:left;">
          <div style="display:block;width:100%;height:50%;float:left;">
            <center>
              <b>
                <p id="targetMaxPh" class="p5text" style="margin:0px;display:inline;">-</p>
              </b>
            </center>
          </div>
          <div style="display:block;width:100%;height:50%;float:left;">
            <div style="display:block;width:15%;height:50%;float:left;"></div>
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="ldbutt" alt="up arrow" onclick="adjustMaxPh(-0.01)" style="float:right;"/>
            </div>
            <div style="display:block;width:20%;height:50%;float:left;"></div>
            <div style="display:block;width:25%;height:55%;float:left;">
              <img class="lubutt" alt="down arrow" onclick="adjustMaxPh(0.01)" style="float:left;"/>
            </div>
            <div style="display:block;width:15%;height:50%;float:left;"></div>
          </div>
        </div>
      ...
      <div id="page9" style="display:none;width:100%;height:100%;">
        <div id="topbar" style="display:block;width:100%;">
		  ...
		  <div class="slideIcon" style="float:left;padding-right:2px;">
            <img id="waterSlideIcon5" style="width:100%;height:100%;" />
          </div>
        </div>
        ...
        <div id="waterPage1" style="display:block;width:94%;height:100%;float:left;">
          ...
          <div style="display:block;width:50%;height:60%;float:left;">
            ...
            <div style="display:block;width:100%;height:50%;float:left;">
              <div style="display:block;width:15%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="ldbutt" alt="up arrow" onclick="adjustMinWaterLvl(-0.1)" style="float:right;"/>
              </div>
              <div style="display:block;width:20%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="lubutt" alt="down arrow" onclick="adjustMinWaterLvl(0.1)" style="float:left;"/>
              </div>
              <div style="display:block;width:15%;height:50%;float:left;"></div>
            </div>
          </div>        
          <div style="display:block;width:50%;height:60%;float:left;">
            ...
            <div style="display:block;width:100%;height:50%;float:left;">
              <div style="display:block;width:15%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="ldbutt" alt="up arrow" onclick="adjustMaxWaterLvl(-0.1)" style="float:right;"/>
              </div>
              <div style="display:block;width:20%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="lubutt" alt="down arrow" onclick="adjustMaxWaterLvl(0.1)" style="float:left;"/>
              </div>
              <div style="display:block;width:15%;height:50%;float:left;"></div>
            </div>
          </div>                
        ...
        <div id="waterPage2" style="display:none;width:94%;height:100%;float:left;">
          ...
          <div style="display:block;width:50%;height:60%;float:left;">
            ...
            <div style="display:block;width:100%;height:50%;float:left;">
              <div style="display:block;width:15%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="ldbutt" alt="up arrow" onclick="adjustMinWaterTemp(-0.1)" style="float:right;"/>
              </div>
              <div style="display:block;width:20%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="lubutt" alt="down arrow" onclick="adjustMinWaterTemp(0.1)" style="float:left;"/>
              </div>
              <div style="display:block;width:15%;height:50%;float:left;"></div>
            </div>
          </div>
          <div style="display:block;width:50%;height:60%;float:left;">
            ...
            <div style="display:block;width:100%;height:50%;float:left;">
              <div style="display:block;width:15%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="ldbutt" alt="up arrow" onclick="adjustMaxWaterTemp(-0.1)" style="float:right;"/>
              </div>
              <div style="display:block;width:20%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="lubutt" alt="down arrow" onclick="adjustMaxWaterTemp(0.1)" style="float:left;"/>
              </div>
              <div style="display:block;width:15%;height:50%;float:left;"></div>
            </div>            
          </div>
		...
		<div id="waterPage3" style="display:none;width:94%;height:100%;float:left;">
          <div style="display:block;width:100%;height:20%;float:left;">
            <b><p style="margin:0px;text-align:center;" class="p3text">Water tank dimensions</p></b>
          </div>
          <div style="display:block;width:100%;height:20%;float:left;">
            <div style="display:block;width:50%;height:100%;float:left;">
              <b>
          ...
          <div style="display:block;width:50%;height:60%;float:left;">
            <div id="targetWaterTankLengthDiv" style="display:block;width:100%;height:45%;float:left;display:flex;justify-content:center;align-items:initial;">
              <b><p id="targetWaterTankLength" class="p5text" style="margin:0px;display:inline;">-</p></b>
              <b><p name="waterIcon" class="p3text" style="margin:0px;display:inline;">cm</p></b>
            </div>
            <div style="display:block;width:100%;height:50%;float:left;">
              <div style="display:block;width:15%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="ldbutt" alt="up arrow" onclick="adjustWaterTankLength(-1)" style="float:right;"/>
              </div>
              <div style="display:block;width:20%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="lubutt" alt="down arrow" onclick="adjustWaterTankLength(1)" style="float:left;"/>
              </div>
              <div style="display:block;width:15%;height:50%;float:left;"></div>
            </div>
          </div>
          <div style="display:block;width:50%;height:60%;float:left;">
            <div id="targetWaterTankWidthDiv" style="display:block;width:100%;height:45%;float:left;display:flex;justify-content:center;align-items:initial;">
              <b><p id="targetWaterTankWidth" class="p5text" style="margin:0px;display:inline;">-</p></b>
              <b><p name="waterIcon" class="p3text" style="margin:0px;display:inline;">cm</p></b>
            </div>
            <div style="display:block;width:100%;height:50%;float:left;">
              <div style="display:block;width:15%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="ldbutt" alt="up arrow" onclick="adjustWaterTankWidth(-0.1)" style="float:right;"/>
              </div>
              <div style="display:block;width:20%;height:50%;float:left;"></div>
              <div style="display:block;width:25%;height:55%;float:left;">
                <img class="lubutt" alt="down arrow" onclick="adjustWaterTankWidth(0.1)" style="float:left;"/>
              </div>
              <div style="display:block;width:15%;height:50%;float:left;"></div>
            </div>            
          </div>
        ...
        <div id="waterPage5" style="display:none;width:94%;height:100%;float:left;">
          <div style="display:block;width:100%;height:20%;float:left;">
...
function setLedColor() {
  ...
  if (dosingInt > 0) {
    ...
    if (!convertToTds && !disableEcWarn) {
      if (ecSensor <= (targetMinEc - ecErrorMargin) || ecSensor >= (targetMaxEc + ecErrorMargin)) {
        errorState = warningState.MAJOR_WARNING;
    ...
    //
    if (!disablePhWarn) {
      if (phSensor <= (targetMinPh - phErrorMargin) || phSensor >= (targetMaxPh + phErrorMargin)) {
        errorState = warningState.MAJOR_WARNING;
    ...
    if (!disableWaterTempWarn) {
      if (waterTemperatureSensor <= (targetMinWaterTemp - waterTempErrorMargin) || waterTemperatureSensor >= (targetMaxWaterTemp + waterTempErrorMargin)) {
        errorState = warningState.MAJOR_WARNING;
    ...
    if (!disableWaterHeightWarn) {
      if (waterLevelSensor <= (targetMinWaterHeight - waterHeightErrorMargin) || waterLevelSensor >= (targetMaxWaterHeight + waterHeightErrorMargin)) {
        errorState = warningState.MAJOR_WARNING;
...
function waterPageSlider(inc) {
  ...
  if (inc < 0) {
    if (waterPageScrollPosition > 0 && waterPageDoserScrollPosition == 0)
        ...
        waterPageScrollPosition = 4;
  }
  else if (inc > 0) {
    if (waterPageScrollPosition < 4)
        waterPageScrollPosition++;
  ...
  if (waterPageScrollPosition == 0) {
    ...
    document.getElementById("targetWaterTankLength").innerHTML = parseFloat(targetWaterTankLength).toFixed(0);
    document.getElementById("targetWaterTankWidth").innerHTML = parseFloat(targetWaterTankWidth).toFixed(0);
    if (convertToInchs) {
      document.getElementById("targetWaterTankLengthDiv").style.alignItems = "initial";
      document.getElementById("targetWaterTankWidthDiv").style.alignItems = "initial";
    }
    else {
    ...
    if (disableDrainAndRefill) {
	  ...
	  for (i = 0;i < 4;i++) {
		...
		if (doserModesArray[index] == doserModes.DOSER_OFF) {
		  document.getElementById("waterEcButton" + (i + 1)).value = "OFF";
		}
		else if (doserModesArray[index] == doserModes.EC_DOSER) {
		  document.getElementById("waterEcButton" + (i + 1)).value = "EC";
		}
		else if (doserModesArray[index] == doserModes.EC_OP_DOSER) {
		  document.getElementById("waterEcButton" + (i + 1)).value = "EC";
		}
		else if (doserModesArray[index] == doserModes.PH_DOWN_DOSER) {
		  document.getElementById("waterEcButton" + (i + 1)).value = "PH-";
		}
		else if (doserModesArray[index] == doserModes.PH_UP_DOSER) {
		  document.getElementById("waterEcButton" + (i + 1)).value = "PH+";
		}
		//
		document.getElementById("d" + (i+1) + "mls").innerHTML = doserMillsArray[index];
	  }
  }  
}
...
function doserPageSlider(inc) {
  ...
  for (i = 0;i < 4;i++) {
	...
	if (doserModesArray[index] == doserModes.DOSER_OFF) {
      ...
      document.getElementById("ecButton" + (i + 1)).style.backgroundColor = "red";
    }
    else if (doserModesArray[index] == doserModes.EC_DOSER) {
      document.getElementById("ecButton" + (i + 1)).value = "EC";
      ...
      document.getElementById("ecButton" + (i + 1)).value = "PH-";
      document.getElementById("ecButton" + (i + 1)).style.backgroundColor = "lime";
    }
    else if (doserModesArray[index] == doserModes.PH_UP_DOSER) {
      document.getElementById("ecButton" + (i + 1)).value = "PH+";
...
function adjustWaterTankLength(inc) {
  targetWaterTankLength = adjustValue(inc, targetWaterTankLength, 0, 999, 1, "targetWaterTankLength");
  document.getElementById("targetWaterTankLength").innerHTML = parseFloat(targetWaterTankLength).toFixed(0);
}

function adjustWaterTankWidth(inc) {
  targetWaterTankWidth = adjustValue(inc, targetWaterTankWidth, 0, 999, 1, "targetWaterTankWidth");
  document.getElementById("targetWaterTankWidth").innerHTML = parseFloat(targetWaterTankWidth).toFixed(0);
}
...
function changeDoserButton(doser) {
  var index = doserPageScrollPosition + doser;
	...
	const doserModesArray = [doserOneMode, doserTwoMode, doserThreeMode, doserFourMode, doserFiveMode, doserSixMode];
    const doserModesStrArray = ["doserOneMode", "doserTwoMode", "doserThreeMode", "doserFourMode", "doserFiveMode", "doserSixMode"];
	
	if (doserModesArray[index-1] == doserModes.DOSER_OFF) {
	  document.getElementById("ecButton" + doser).value = "OFF";
	  document.getElementById("ecButton" + doser).style.backgroundColor = "red";
	}
	else if (doserModesArray[index-1] == doserModes.EC_DOSER) {
	  document.getElementById("ecButton" + doser).value = "EC";
	  document.getElementById("ecButton" + doser).style.backgroundColor = "lime";
	}
	else if (doserModesArray[index-1] == doserModes.EC_OP_DOSER) {
	  document.getElementById("ecButton" + doser).value = "EC#";
	  document.getElementById("ecButton" + doser).style.backgroundColor = "lime";
	}
	else if (doserModesArray[index-1] == doserModes.PH_DOWN_DOSER) {
	  document.getElementById("ecButton" + doser).value = "PH-";
	  document.getElementById("ecButton" + doser).style.backgroundColor = "lime";
	}
	else if (doserModesArray[index-1] == doserModes.PH_UP_DOSER) {
	  document.getElementById("ecButton" + doser).value = "PH+";
	  document.getElementById("ecButton" + doser).style.backgroundColor = "lime";
	}
	setVal(doserModesStrArray[index-1], doserModesArray[index-1]);
}
